  ...
  return (
    <div className="max-w-xl mx-auto space-y-8 animate-fade-in">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Finalize Booking</h1>
        <p className="text-muted-foreground">Confirm your appointment details below.</p>
      </div>

      <div className="bg-card border rounded-2xl overflow-hidden shadow-sm p-8 text-center space-y-6">
