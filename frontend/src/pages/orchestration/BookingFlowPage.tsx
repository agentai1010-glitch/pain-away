  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 space-y-6 sm:space-y-8 animate-fade-in pb-24 pt-4 sm:pt-6">
      <div className="text-center space-y-2">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Book an Appointment</h1>
        <p className="text-sm sm:text-base text-muted-foreground">Complete your public booking in a few simple steps.</p>
      </div>
        ...
        <div className="space-y-8 animate-slide-up">
          ...
          <div className="bg-card border rounded-2xl p-6 shadow-sm">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Showing gender-specific capacity for <strong className="text-foreground">{patientData.gender}</strong> patients. You can only select slots with available capacity for your gender.
            </p>
