...
from .schemas import PatientDashboardResponse, PatientAppointmentResponse, PatientOrderResponse, PatientDocumentResponse
...
async def get_patient_documents(
    ...
    """Retrieve all financial documents for the authenticated patient."""
    service = PatientPortalService(db)
    return await service.get_patient_documents(current_user)
